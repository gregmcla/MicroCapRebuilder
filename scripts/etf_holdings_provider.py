...
DEFAULT_ETFS = [
    # Small-cap / Micro-cap
    ETFConfig("IWM", "iShares Russell 2000 ETF", "small-cap", 200),
    ETFConfig("IJR", "iShares Core S&P Small-Cap ETF", "small-cap", 200),
    ETFConfig("VB", "Vanguard Small-Cap ETF", "small-cap", 200),
    # Mid-cap
    ETFConfig("IJH", "iShares Core S&P Mid-Cap ETF", "mid-cap", 150),
    ETFConfig("VO", "Vanguard Mid-Cap ETF", "mid-cap", 150),
    ETFConfig("MDY", "SPDR S&P MidCap 400 ETF", "mid-cap", 150),
    # Large-cap
    ETFConfig("SPY", "SPDR S&P 500 ETF", "large-cap", 500),
    ETFConfig("QQQ", "Invesco QQQ Trust", "large-cap-growth", 100),
    ETFConfig("VTV", "Vanguard Value ETF", "large-cap-value", 200),
    ETFConfig("VUG", "Vanguard Growth ETF", "large-cap-growth", 200),
    ETFConfig("DIA", "SPDR Dow Jones Industrial Average ETF", "large-cap", 30),
    # Sectors
    ETFConfig("XLK", "Technology Select Sector SPDR", "sector-tech", 75),
    ETFConfig("XLV", "Health Care Select Sector SPDR", "sector-health", 75),
    ETFConfig("XLF", "Financial Select Sector SPDR", "sector-finance", 75),
    ETFConfig("XLI", "Industrial Select Sector SPDR", "sector-industrial", 75),
    ETFConfig("XLY", "Consumer Discretionary Select Sector SPDR", "sector-consumer-disc", 75),
    ETFConfig("XLP", "Consumer Staples Select Sector SPDR", "sector-consumer-staples", 75),
    ETFConfig("XLE", "Energy Select Sector SPDR", "sector-energy", 75),
    ETFConfig("XLB", "Materials Select Sector SPDR", "sector-materials", 75),
    ETFConfig("XLU", "Utilities Select Sector SPDR", "sector-utilities", 75),
