        ...
        >
          ...
          <defs>
            <linearGradient id={`gradient-${symbol}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" className="[stop-color:var(--color-cyber-cyan)]" stopOpacity="0.3" />
              <stop offset="100%" className="[stop-color:var(--color-cyber-cyan)]" stopOpacity="0" />
            </linearGradient>
          </defs>
          <polyline
            points={sparklinePoints}
            fill="none"
            className="[stroke:var(--color-cyber-cyan)]"
            strokeWidth="1.5"
          />
          <polygon
...
export default function MarketTickerBanner() {
  ...
  return (
    <div className="h-[60px] bg-bg-primary border-b border-cyber-cyan/20 shadow-glow-cyan flex items-center" role="region" aria-label="Market indices ticker">
