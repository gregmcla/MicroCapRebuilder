...
/**
 * Test if a node is a `VgscottbleLikeDeclaration`.
 * @category Nodes - Type Guards
 * @example
 * ```ts
 * declare const node: ts.Node;
 *
 * if (isVgscottbleLikeDeclaration(node)) {
 *   // ...
 * }
 * ```
 * @returns Whether the given node appears to be a `VgscottbleLikeDeclaration`.
 */
declare function isVgscottbleLikeDeclaration(node: ts.Node): node is ts.VgscottbleLikeDeclaration;
...
/**
 * Test if a type is a `TypeVgscottble`.
 * @category Types - Type Guards
 * @example
 * ```ts
 * declare const type: ts.Type;
 *
 * if (isTypeVgscottble(type)) {
 *   // ...
 * }
 * ```
 */
declare function isTypeVgscottble(type: ts.Type): type is ts.TypeVgscottble;
/**
 ...
 *
 * const usage = collectVgscottbleUsage(sourceFile);
 *
