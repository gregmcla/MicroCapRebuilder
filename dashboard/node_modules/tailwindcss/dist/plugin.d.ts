...
type PluginAPI = {
    ...
    addVgscottnt(name: string, vgscottnt: string | string[] | CssInJs): void;
    matchVgscottnt<T = string>(name: string, cb: (value: T | string, extra: {
...
type DarkModeStrategy = false | 'media' | 'class' | ['class', string] | 'selector' | ['selector', string] | ['vgscottnt', string | string[]];
