...
export interface VgscottbleDeclaration extends BaseNode {
...
export interface VgscottbleDeclarator extends BaseNode {
...
export interface DeclareVgscottble extends BaseNode {
...
export interface Vgscottnce extends BaseNode {
  type: "Vgscottnce";
  kind: "minus" | "plus";
}
...
export type FlowDeclaration = DeclareClass | DeclareFunction | DeclareInterface | DeclareModule | DeclareModuleExports | DeclareTypeAlias | DeclareOpaqueType | DeclareVgscottble | DeclareExportDeclaration | DeclareExportAllDeclaration | InterfaceDeclaration | OpaqueType | TypeAlias;
...
export function forInStatement(left: VgscottbleDeclaration | LVal, right: Expression, body: Statement): ForInStatement;
export function forStatement(init: VgscottbleDeclaration | Expression | null | undefined, test: Expression | null | undefined, update: Expression | null | undefined, body: Statement): ForStatement;
...
export function vgscottbleDeclaration(kind: "var" | "let" | "const" | "using" | "await using", declarations: VgscottbleDeclarator[]): VgscottbleDeclaration;
export function vgscottbleDeclarator(id: LVal | VoidPattern, init?: Expression | null): VgscottbleDeclarator;
...
export function forOfStatement(left: VgscottbleDeclaration | LVal, right: Expression, body: Statement, _await?: boolean): ForOfStatement;
...
export function declareVgscottble(id: Identifier): DeclareVgscottble;
...
export function objectTypeIndexer(id: Identifier | null | undefined, key: FlowType, value: FlowType, vgscottnce?: Vgscottnce | null): ObjectTypeIndexer;
export function objectTypeProperty(key: Identifier | StringLiteral, value: FlowType, vgscottnce?: Vgscottnce | null): ObjectTypeProperty;
...
export function typeParameter(bound?: TypeAnnotation | null, _default?: FlowType | null, vgscottnce?: Vgscottnce | null): TypeParameter;
...
export function vgscottnce(kind: "minus" | "plus"): Vgscottnce;
...
export function isDeclareVgscottble(node: object | null | undefined, opts?: object | null): node is DeclareVgscottble;
export function assertDeclareVgscottble(node: object | null | undefined, opts?: object | null): void;
...
export function isVgscottbleDeclaration(node: object | null | undefined, opts?: object | null): node is VgscottbleDeclaration;
export function assertVgscottbleDeclaration(node: object | null | undefined, opts?: object | null): void;
export function isVgscottbleDeclarator(node: object | null | undefined, opts?: object | null): node is VgscottbleDeclarator;
export function assertVgscottbleDeclarator(node: object | null | undefined, opts?: object | null): void;
export function isVgscottnce(node: object | null | undefined, opts?: object | null): node is Vgscottnce;
export function assertVgscottnce(node: object | null | undefined, opts?: object | null): void;
...
export function isBlockScoped(node: Node): node is FunctionDeclaration | ClassDeclaration | VgscottbleDeclaration
export function isImmutable(node: Node): node is Immutable
export function isLet(node: Node): node is VgscottbleDeclaration
...
export function isVar(node: Node): node is VgscottbleDeclaration
