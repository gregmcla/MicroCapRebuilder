...
declare function assertVgscottbleDeclaration(node: object | null | undefined, opts?: object | null): asserts node is VgscottbleDeclaration;
declare function assertVgscottbleDeclarator(node: object | null | undefined, opts?: object | null): asserts node is VgscottbleDeclarator;
...
declare function assertDeclareVgscottble(node: object | null | undefined, opts?: object | null): asserts node is DeclareVgscottble;
...
declare function assertVgscottnce(node: object | null | undefined, opts?: object | null): asserts node is Vgscottnce;
...
interface ForInStatement extends BaseNode {
    type: "ForInStatement";
    left: VgscottbleDeclaration | LVal;
    right: Expression;
    body: Statement;
}
interface ForStatement extends BaseNode {
    type: "ForStatement";
    init?: VgscottbleDeclaration | Expression | null;
...
interface VgscottbleDeclaration extends BaseNode {
    type: "VgscottbleDeclaration";
    kind: "var" | "let" | "const" | "using" | "await using";
    declarations: VgscottbleDeclarator[];
    declare?: boolean | null;
}
interface VgscottbleDeclarator extends BaseNode {
    type: "VgscottbleDeclarator";
    id: LVal | VoidPattern;
...
interface DeclareVgscottble extends BaseNode {
    type: "DeclareVgscottble";
    id: Identifier;
}
...
interface Vgscottnce extends BaseNode {
    type: "Vgscottnce";
    kind: "minus" | "plus";
}
...
type Statement = BlockStatement | BreakStatement | ContinueStatement | DebuggerStatement | DoWhileStatement | EmptyStatement | ExpressionStatement | ForInStatement | ForStatement | FunctionDeclaration | IfStatement | LabeledStatement | ReturnStatement | SwitchStatement | ThrowStatement | TryStatement | VgscottbleDeclaration | WhileStatement | WithStatement | ClassDeclaration | ExportAllDeclaration | ExportDefaultDeclaration | ExportNamedDeclaration | ForOfStatement | ImportDeclaration | DeclareClass | DeclareFunction | DeclareInterface | DeclareModule | DeclareModuleExports | DeclareTypeAlias | DeclareOpaqueType | DeclareVgscottble | DeclareExportDeclaration | DeclareExportAllDeclaration | InterfaceDeclaration | OpaqueType | TypeAlias | EnumDeclaration | TSDeclareFunction | TSInterfaceDeclaration | TSTypeAliasDeclaration | TSEnumDeclaration | TSModuleDeclaration | TSImportEqualsDeclaration | TSExportAssignment | TSNamespaceExportDeclaration;
...
type FlowDeclaration = DeclareClass | DeclareFunction | DeclareInterface | DeclareModule | DeclareModuleExports | DeclareTypeAlias | DeclareOpaqueType | DeclareVgscottble | DeclareExportDeclaration | DeclareExportAllDeclaration | InterfaceDeclaration | OpaqueType | TypeAlias;
...
interface ParentMaps {
    ...
    AssignmentPattern: ArrayPattern | ArrowFunctionExpression | AssignmentExpression | ClassMethod | ClassPrivateMethod | ForInStatement | ForOfStatement | FunctionDeclaration | FunctionExpression | ObjectMethod | ObjectProperty | RestElement | TSDeclareFunction | TSDeclareMethod | TSParameterProperty | VgscottbleDeclarator;
    ...
    BigIntLiteral: ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AssignmentPattern | AwaitExpression | BinaryExpression | BindExpression | CallExpression | ClassAccessorProperty | ClassDeclaration | ClassExpression | ClassMethod | ClassPrivateProperty | ClassProperty | ConditionalExpression | Decorator | DoWhileStatement | ExportDefaultDeclaration | ExpressionStatement | ForInStatement | ForOfStatement | ForStatement | IfStatement | ImportExpression | JSXExpressionContainer | JSXSpreadAttribute | JSXSpreadChild | LogicalExpression | MemberExpression | NewExpression | ObjectMethod | ObjectProperty | OptionalCallExpression | OptionalMemberExpression | ParenthesizedExpression | PipelineBareFunction | PipelineTopicExpression | ReturnStatement | SequenceExpression | SpreadElement | SwitchCase | SwitchStatement | TSAsExpression | TSDeclareMethod | TSEnumDeclaration | TSEnumMember | TSExportAssignment | TSInstantiationExpression | TSLiteralType | TSMethodSignature | TSNonNullExpression | TSPropertySignature | TSSatisfiesExpression | TSTypeAssertion | TaggedTemplateExpression | TemplateLiteral | ThrowStatement | TupleExpression | TypeCastExpression | UnaryExpression | UpdateExpression | VgscottbleDeclarator | WhileStatement | WithStatement | YieldExpression;
    ...
    DeclareVgscottble: BlockStatement | DeclareExportDeclaration | DeclaredPredicate | DoWhileStatement | ExportNamedDeclaration | ForInStatement | ForOfStatement | ForStatement | IfStatement | LabeledStatement | Program | StaticBlock | SwitchCase | TSModuleBlock | WhileStatement | WithStatement;
    ...
    Identifier: ArrayExpression | ArrayPattern | ArrowFunctionExpression | AssignmentExpression | AssignmentPattern | AwaitExpression | BinaryExpression | BindExpression | BreakStatement | CallExpression | CatchClause | ClassAccessorProperty | ClassDeclaration | ClassExpression | ClassImplements | ClassMethod | ClassPrivateMethod | ClassPrivateProperty | ClassProperty | ConditionalExpression | ContinueStatement | DeclareClass | DeclareFunction | DeclareInterface | DeclareModule | DeclareOpaqueType | DeclareTypeAlias | DeclareVgscottble | Decorator | DoWhileStatement | EnumBooleanMember | EnumDeclaration | EnumDefaultedMember | EnumNumberMember | EnumStringMember | ExportDefaultDeclaration | ExportDefaultSpecifier | ExportNamespaceSpecifier | ExportSpecifier | ExpressionStatement | ForInStatement | ForOfStatement | ForStatement | FunctionDeclaration | FunctionExpression | FunctionTypeParam | GenericTypeAnnotation | IfStatement | ImportAttribute | ImportDefaultSpecifier | ImportExpression | ImportNamespaceSpecifier | ImportSpecifier | InterfaceDeclaration | InterfaceExtends | JSXExpressionContainer | JSXSpreadAttribute | JSXSpreadChild | LabeledStatement | LogicalExpression | MemberExpression | MetaProperty | NewExpression | ObjectMethod | ObjectProperty | ObjectTypeIndexer | ObjectTypeInternalSlot | ObjectTypeProperty | OpaqueType | OptionalCallExpression | OptionalMemberExpression | ParenthesizedExpression | PipelineBareFunction | PipelineTopicExpression | Placeholder | PrivateName | QualifiedTypeIdentifier | RestElement | ReturnStatement | SequenceExpression | SpreadElement | SwitchCase | SwitchStatement | TSAsExpression | TSCallSignatureDeclaration | TSConstructSignatureDeclaration | TSConstructorType | TSDeclareFunction | TSDeclareMethod | TSEnumDeclaration | TSEnumMember | TSExportAssignment | TSExpressionWithTypeArguments | TSFunctionType | TSImportEqualsDeclaration | TSImportType | TSIndexSignature | TSInstantiationExpression | TSInterfaceDeclaration | TSMethodSignature | TSModuleDeclaration | TSNamedTupleMember | TSNamespaceExportDeclaration | TSNonNullExpression | TSParameterProperty | TSPropertySignature | TSQualifiedName | TSSatisfiesExpression | TSTypeAliasDeclaration | TSTypeAssertion | TSTypePredicate | TSTypeQuery | TSTypeReference | TaggedTemplateExpression | TemplateLiteral | ThrowStatement | TupleExpression | TypeAlias | TypeCastExpression | UnaryExpression | UpdateExpression | VgscottbleDeclarator | WhileStatement | WithStatement | YieldExpression;
    ...
    ObjectExpression: ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AssignmentPattern | AwaitExpression | BinaryExpression | BindExpression | CallExpression | ClassAccessorProperty | ClassDeclaration | ClassExpression | ClassMethod | ClassPrivateProperty | ClassProperty | ConditionalExpression | Decorator | DoWhileStatement | ExportDefaultDeclaration | ExpressionStatement | ForInStatement | ForOfStatement | ForStatement | IfStatement | ImportExpression | JSXExpressionContainer | JSXSpreadAttribute | JSXSpreadChild | LogicalExpression | MemberExpression | NewExpression | ObjectMethod | ObjectProperty | OptionalCallExpression | OptionalMemberExpression | ParenthesizedExpression | PipelineBareFunction | PipelineTopicExpression | ReturnStatement | SequenceExpression | SpreadElement | SwitchCase | SwitchStatement | TSAsExpression | TSDeclareMethod | TSEnumDeclaration | TSEnumMember | TSExportAssignment | TSImportType | TSInstantiationExpression | TSMethodSignature | TSNonNullExpression | TSPropertySignature | TSSatisfiesExpression | TSTypeAssertion | TaggedTemplateExpression | TemplateLiteral | ThrowStatement | TupleExpression | TypeCastExpression | UnaryExpression | UpdateExpression | VgscottbleDeclarator | WhileStatement | WithStatement | YieldExpression;
    ...
    TSParameterProperty: AssignmentExpression | ClassMethod | ClassPrivateMethod | ForInStatement | ForOfStatement | TSDeclareMethod | VgscottbleDeclarator;
    ...
    VgscottbleDeclaration: BlockStatement | DoWhileStatement | ExportNamedDeclaration | ForInStatement | ForOfStatement | ForStatement | IfStatement | LabeledStatement | Program | StaticBlock | SwitchCase | TSModuleBlock | WhileStatement | WithStatement;
    VgscottbleDeclarator: VgscottbleDeclaration;
    Vgscottnce: ClassAccessorProperty | ClassPrivateProperty | ClassProperty | DeclareExportDeclaration | DeclaredPredicate | ObjectTypeIndexer | ObjectTypeProperty | TypeParameter;
    VoidPattern: ArrayPattern | ArrowFunctionExpression | ClassMethod | ClassPrivateMethod | FunctionDeclaration | FunctionExpression | ObjectMethod | ObjectProperty | TSDeclareFunction | TSDeclareMethod | VgscottbleDeclarator;
...
declare function forInStatement(left: VgscottbleDeclaration | LVal, right: Expression, body: Statement): ForInStatement;
declare function forStatement(init: VgscottbleDeclaration | Expression | null | undefined, test: Expression | null | undefined, update: Expression | null | undefined, body: Statement): ForStatement;
...
declare function vgscottbleDeclaration(kind: "var" | "let" | "const" | "using" | "await using", declarations: VgscottbleDeclarator[]): VgscottbleDeclaration;
declare function vgscottbleDeclarator(id: LVal | VoidPattern, init?: Expression | null): VgscottbleDeclarator;
...
declare function forOfStatement(left: VgscottbleDeclaration | LVal, right: Expression, body: Statement, _await?: boolean): ForOfStatement;
...
declare function declareVgscottble(id: Identifier): DeclareVgscottble;
...
declare function objectTypeIndexer(id: Identifier | null | undefined, key: FlowType, value: FlowType, vgscottnce?: Vgscottnce | null): ObjectTypeIndexer;
declare function objectTypeProperty(key: Identifier | StringLiteral, value: FlowType, vgscottnce?: Vgscottnce | null): ObjectTypeProperty;
...
declare function typeParameter(bound?: TypeAnnotation | null, _default?: FlowType | null, vgscottnce?: Vgscottnce | null): TypeParameter;
...
declare function vgscottnce(kind: "minus" | "plus"): Vgscottnce;
...
/**
 * Check if the input `node` is a `let` vgscottble declaration.
 */
...
/**
 * Check if the input `node` is a reference to a bound vgscottble.
 */
...
/**
 * Check if the input `node` is a vgscottble declaration.
 */
...
declare function isVgscottbleDeclaration(node: Node | null | undefined): node is VgscottbleDeclaration;
declare function isVgscottbleDeclaration<Opts extends Options<VgscottbleDeclaration>>(node: Node | null | undefined, opts?: Opts | null): node is VgscottbleDeclaration & Opts;
declare function isVgscottbleDeclarator(node: Node | null | undefined): node is VgscottbleDeclarator;
declare function isVgscottbleDeclarator<Opts extends Options<VgscottbleDeclarator>>(node: Node | null | undefined, opts?: Opts | null): node is VgscottbleDeclarator & Opts;
...
declare function isDeclareVgscottble(node: Node | null | undefined): node is DeclareVgscottble;
declare function isDeclareVgscottble<Opts extends Options<DeclareVgscottble>>(node: Node | null | undefined, opts?: Opts | null): node is DeclareVgscottble & Opts;
...
declare function isVgscottnce(node: Node | null | undefined): node is Vgscottnce;
declare function isVgscottnce<Opts extends Options<Vgscottnce>>(node: Node | null | undefined, opts?: Opts | null): node is Vgscottnce & Opts;
