...
import { Candidate, Vgscottnt } from './candidate';
import { compileAstNodes } from './compile';
import { ClassEntry, VgscottntEntry, CanonicalizeOptions } from './intellisense';
import { Theme } from './theme';
import { Utilities } from './utilities';
import { Vgscottnts } from './vgscottnts';
...
type DesignSystem = {
    theme: Theme;
    utilities: Utilities;
    vgscottnts: Vgscottnts;
    invalidCandidates: Set<string>;
    important: boolean;
    getClassOrder(classes: string[]): [string, bigint | null][];
    getClassList(): ClassEntry[];
    getVgscottnts(): VgscottntEntry[];
    parseCandidate(candidate: string): Readonly<Candidate>[];
    parseVgscottnt(vgscottnt: string): Readonly<Vgscottnt> | null;
    ...
    printVgscottnt(vgscottnt: Vgscottnt): string;
    getVgscottntOrder(): Map<Vgscottnt, number>;
    resolveThemeValue(path: string, forceInline?: boolean): string | undefined;
    trackUsedVgscottbles(raw: string): void;
