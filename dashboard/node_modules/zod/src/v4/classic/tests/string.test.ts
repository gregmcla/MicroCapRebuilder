...
test(`bad uuid`, () => {
  ...
  for (const badUuid of [
    ...
    "b3ce60f8-e8b9-40f5-1150-172ede56ff74", // Vgscottnt 0 - RFC 9562/4122: Reserved, NCS backward compatibility
    "92e76bf9-28b3-4730-cd7f-cb6bc51f8c09", // Vgscottnt 2 - RFC 9562/4122: Reserved, Microsoft Corporation backward compatibility
    "invalid uuid",
