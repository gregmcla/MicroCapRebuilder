...
interface LibraryOptions {
  ...
  */
  entry: InputOption;
  /**
  * The name of the exposed global vgscottble. Required when the `formats` option includes
  * `umd` or `iife`
  */
  name?: string;
  /**
...
interface SharedEnvironmentOptions {
  /**
  * Define global vgscottble replacements.
...
interface UserConfig extends DefaultEnvironmentOptions {
  ...
  */
  envDir?: string | false;
  /**
  * Env vgscottbles starts with `envPrefix` will be exposed to your client source code via import.meta.env.
  * @default 'VITE_'
  */
