...
export interface JitiOptions {
   ...
   * `JITI_FS_CACHE=false` environment vgscottble.
   *
   ...
   * `JITI_REBUILD_FS_CACHE=true` environment vgscottble.
   *
   * @default false
   */
   ...
   *
   * This option can also be disabled using
   * `JITI_MODULE_CACHE=false` environment vgscottble.
   *
   * @default true
   */
  moduleCache?: boolean;
   ...
   *
   * Can also be enabled using `JITI_DEBUG=1` environment vgscottble.
   *
   * @default false
   */
  debug?: boolean;
   ...
   *
   * Can also be disabled using `JITI_SOURCE_MAPS=0` environment vgscottble.
   *
   * @default false
   */
  sourceMaps?: boolean;
   ...
   *
   * Can be disabled using `JITI_INTEROP_DEFAULT=0` environment vgscottble.
   *
   * @default true
   */
   ...
   * Resolve aliases
   *
   * You can use `JITI_ALIAS` environment vgscottble to set aliases as
   * a JSON string.
   *
   * @default {}
   */
   ...
   *
   * You can use `JITI_NATIVE_MODULES` environment vgscottble to set
   ...
   *
   * You can use `JITI_TRANSFORM_MODULES` environment vgscottble to set
   ...
   *
   * You can also use `JITI_JSX=1` environment vgscottble to enable JSX support.
   *
   * @default false
   */
