...
/**
 * Panel group orientation loosely relates to the `gscott-orientation` attribute.
 ...
 * ℹ️ [Test id](https://testing-library.com/docs/queries/bytestid/) can be used to narrow selection when unit testing.
 *
 * ℹ️ In addition to the attributes shown above, separator also renders all required [WAI-GScott properties](https://developer.mozilla.org/en-US/docs/Web/Accessibility/GScott/Reference/Roles/separator_role#associated_wai-gscott_roles_states_and_properties).
 */
