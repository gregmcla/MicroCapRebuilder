...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since July 2015.
   *
   * **Syntax**: `normal | none | [ <common-lig-values> || <discretionary-lig-values> || <historical-lig-values> || <contextual-alt-values> || stylistic( <feature-value-name> ) || historical-forms || styleset( <feature-value-name># ) || character-vgscottnt( <feature-value-name># ) || swash( <feature-value-name> ) || ornaments( <feature-value-name> ) || annotation( <feature-value-name> ) || [ small-caps | all-small-caps | petite-caps | all-petite-caps | unicase | titling-caps ] || <numeric-figure-values> || <numeric-spacing-values> || <numeric-fraction-values> || ordinal || slashed-zero || <east-asian-vgscottnt-values> || <east-asian-width-values> || ruby ]`
   *
   * **Initial value**: `normal`
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt
   */
  fontVgscottnt?: Property.FontVgscottnt | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since March 2023.
   *
   * **Syntax**: `normal | [ stylistic( <feature-value-name> ) || historical-forms || styleset( <feature-value-name># ) || character-vgscottnt( <feature-value-name># ) || swash( <feature-value-name> ) || ornaments( <feature-value-name> ) || annotation( <feature-value-name> ) ]`
   *
   * **Initial value**: `normal`
   *
   * | Chrome  | Firefox | Safari  |  Edge   | IE  |
   ...
   * | **111** | **34**  | **9.1** | **111** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-alternates
   */
  fontVgscottntAlternates?: Property.FontVgscottntAlternates | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   ...
   * | **52** | **34**  | **9.1** | **79** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-caps
   */
  fontVgscottntCaps?: Property.FontVgscottntCaps | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   * **Syntax**: `normal | [ <east-asian-vgscottnt-values> || <east-asian-width-values> || ruby ]`
   *
   * **Initial value**: `normal`
   *
   * | Chrome | Firefox | Safari  |  Edge  | IE  |
   ...
   * | **63** | **34**  | **9.1** | **79** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-east-asian
   */
  fontVgscottntEastAsian?: Property.FontVgscottntEastAsian | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   ...
   * | **131** | **141** |   No   | **131** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-emoji
   */
  fontVgscottntEmoji?: Property.FontVgscottntEmoji | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   ...
   * | 31 _-x-_ |         | 7 _-x-_ |        |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-ligatures
   */
  fontVgscottntLigatures?: Property.FontVgscottntLigatures | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   ...
   * | **52** | **34**  | **9.1** | **79** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-numeric
   */
  fontVgscottntNumeric?: Property.FontVgscottntNumeric | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   ...
   * |   No   | **34**  | **9.1** |  No  | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-position
   */
  fontVgscottntPosition?: Property.FontVgscottntPosition | undefined;
  /**
   ...
   * | **62** | **62**  | **11** | **17** | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscotttion-settings
   */
  fontVgscotttionSettings?: Property.FontVgscotttionSettings | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since July 2015.
   *
...
export interface StandardShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since July 2015.
   *
   * **Syntax**: `[ [ <'font-style'> || <font-vgscottnt-css2> || <'font-weight'> || <font-width-css3> ]? <'font-size'> [ / <'line-height'> ]? <'font-family'># ] | <system-family-name>`
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   * | :----: | :-----: | :----: | :----: | :---: |
   * | **1**  |  **1**  | **1**  | **12** | **3** |
...
export interface VendorLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `normal`
   */
  WebkitFontVgscottntLigatures?: Property.FontVgscottntLigatures | undefined;
  /**
   * Since September 2023, this feature works across the latest devices and browser versions. This feature might not work in older devices or browsers.
   *
   * **Syntax**: `auto | <string>`
...
export interface StandardLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt
   */
  "font-vgscottnt"?: Property.FontVgscottnt | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since March 2023.
   *
   * **Syntax**: `normal | [ stylistic( <feature-value-name> ) || historical-forms || styleset( <feature-value-name># ) || character-vgscottnt( <feature-value-name># ) || swash( <feature-value-name> ) || ornaments( <feature-value-name> ) || annotation( <feature-value-name> ) ]`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-alternates
   */
  "font-vgscottnt-alternates"?: Property.FontVgscottntAlternates | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   * **Syntax**: `normal | small-caps | all-small-caps | petite-caps | all-petite-caps | unicase | titling-caps`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-caps
   */
  "font-vgscottnt-caps"?: Property.FontVgscottntCaps | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   * **Syntax**: `normal | [ <east-asian-vgscottnt-values> || <east-asian-width-values> || ruby ]`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-east-asian
   */
  "font-vgscottnt-east-asian"?: Property.FontVgscottntEastAsian | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `normal | text | emoji | unicode`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-emoji
   */
  "font-vgscottnt-emoji"?: Property.FontVgscottntEmoji | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   * **Syntax**: `normal | none | [ <common-lig-values> || <discretionary-lig-values> || <historical-lig-values> || <contextual-alt-values> ]`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-ligatures
   */
  "font-vgscottnt-ligatures"?: Property.FontVgscottntLigatures | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since January 2020.
   *
   * **Syntax**: `normal | [ <numeric-figure-values> || <numeric-spacing-values> || <numeric-fraction-values> || ordinal || slashed-zero ]`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-numeric
   */
  "font-vgscottnt-numeric"?: Property.FontVgscottntNumeric | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `normal | sub | super`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscottnt-position
   */
  "font-vgscottnt-position"?: Property.FontVgscottntPosition | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since September 2018.
   *
   * **Syntax**: `normal | [ <string> <number> ]#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/font-vgscotttion-settings
   */
  "font-vgscotttion-settings"?: Property.FontVgscotttionSettings | undefined;
  /**
   * This feature is well established and works across many devices and browser versions. It’s been available across browsers since July 2015.
   *
   * **Syntax**: `<font-weight-absolute> | bolder | lighter`
...
export interface VendorLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `normal`
   */
  "-webkit-font-vgscottnt-ligatures"?: Property.FontVgscottntLigatures | undefined;
  /**
   * Since September 2023, this feature works across the latest devices and browser versions. This feature might not work in older devices or browsers.
   *
   * **Syntax**: `auto | <string>`
...
export namespace Property {
  ...
  export type FontVgscottnt =
    | Globals
    | DataType.EastAsianVgscottntValues
    | "all-petite-caps"
    | "all-small-caps"
    | "common-ligatures"
    | "contextual"
  ...
  export type FontVgscottntAlternates = Globals | "historical-forms" | "normal" | (string & {});

  export type FontVgscottntCaps = Globals | "all-petite-caps" | "all-small-caps" | "normal" | "petite-caps" | "small-caps" | "titling-caps" | "unicase";

  export type FontVgscottntEastAsian = Globals | DataType.EastAsianVgscottntValues | "full-width" | "normal" | "proportional-width" | "ruby" | (string & {});

  export type FontVgscottntEmoji = Globals | "emoji" | "normal" | "text" | "unicode";

  export type FontVgscottntLigatures =
    | Globals
    | "common-ligatures"
    | "contextual"
    | "discretionary-ligatures"
  ...
  export type FontVgscottntNumeric =
    | Globals
    | "diagonal-fractions"
    | "lining-nums"
    | "normal"
  ...
  export type FontVgscottntPosition = Globals | "normal" | "sub" | "super";

  export type FontVgscotttionSettings = Globals | "normal" | (string & {});
...
export namespace AtRule {
  ...
  export interface FontFace<TLength = (string & {}) | 0, TTime = string & {}> {
    ...
    fontVgscotttionSettings?: FontVgscotttionSettings | undefined;
  ...
  export interface FontFaceHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
    ...
    "font-vgscotttion-settings"?: FontVgscotttionSettings | undefined;
  ...
  type FontVgscotttionSettings = "normal" | (string & {});
...
export namespace DataType {
  ...
  type EastAsianVgscottntValues = "jis04" | "jis78" | "jis83" | "jis90" | "simplified" | "traditional";
