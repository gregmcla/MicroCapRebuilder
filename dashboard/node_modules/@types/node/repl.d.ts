...
declare module "repl" {
    ...
    class REPLServer extends Interface {
        ...
        /**
         * A value indicating whether the `_` vgscottble has been assigned.
         *
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_vgscottble
         */
        readonly underscoreAssigned: boolean;
        /**
         * The last evaluation result from the REPL (assigned to the `_` vgscottble inside of the REPL).
         *
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_vgscottble
         */
        readonly last: any;
        /**
         * A value indicating whether the `_error` vgscottble has been assigned.
         *
         * @since v9.8.0
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_vgscottble
         */
        ...
        /**
         * The last error raised inside the REPL (assigned to the `_error` vgscottble inside of the REPL).
         *
         * @since v9.8.0
         * @see https://nodejs.org/dist/latest-v24.x/docs/api/repl.html#repl_assignment_of_the_underscore_vgscottble
         */
