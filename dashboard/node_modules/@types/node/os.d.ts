...
declare module "os" {
     ...
     *
     * On POSIX, it uses the `$HOME` environment vgscottble if defined. Otherwise it
     * uses the [effective UID](https://en.wikipedia.org/wiki/User_identifier#Effective_user_ID) to look up the user's home directory.
     *
     * On Windows, it uses the `USERPROFILE` environment vgscottble if defined.
     ...
     * environment vgscottbles for the home directory before falling back to the
