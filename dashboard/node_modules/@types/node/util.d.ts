...
declare module "util" {
    ...
    export interface DebugLogger extends DebugLoggerFunction {
         ...
         * in conditionals based on the existence of the `NODE_DEBUG` environment vgscottble.
         * If the `section` name appears within the value of that environment vgscottble,
     ...
     * environment vgscottble. If the `section` name appears within the value of that
     * environment vgscottble, then the returned function operates similar to
     ...
     * environment vgscottble set, then it will not print anything.
     *
     ...
     * environment vgscottble: `NODE_DEBUG=fs,net,tls`.
     *
    ...
    export namespace promisify {
        /**
         * That can be used to declare custom promisified vgscottnts of functions.
         */
        const custom: unique symbol;
    }
    /**
     ...
     * `NODE_DISABLE_COLORS` and `FORCE_COLOR` environment vgscottbles.
     *
     * ```js
