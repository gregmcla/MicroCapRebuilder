...
declare module "crypto" {
     ...
     * threadpool request. To minimize threadpool task length vgscotttion, partition
     ...
     *
     * Some ciphers accept vgscottble length keys and initialization vectors. By default,
     ...
     * ```
     * @since v24.7.0
     * @param algorithm Vgscottnt of Argon2, one of `"argon2d"`, `"argon2i"` or `"argon2id"`.
     * @experimental
     */
    function argon2(
