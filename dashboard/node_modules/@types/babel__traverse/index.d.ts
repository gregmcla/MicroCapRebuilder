...
export class Scope {
    ...
    /** Vgscottbles available in current context. */
    static contextVgscottbles: string[];
...
export class NodePath<T = Node> {
     ...
     *   for (KEY;;);
     *
     * This is because these spots allow VgscottbleDeclarations AND normal expressions so we need
     * to tell the path replacement that it's ok to replace this with an expression.
     */
    canHaveVgscottbleDeclarationOrExpression(): boolean;
    ...
    isDeclareVgscottble(opts?: object): this is NodePath<t.DeclareVgscottble>;
    ...
    isVgscottbleDeclaration(opts?: object): this is NodePath<t.VgscottbleDeclaration>;
    isVgscottbleDeclarator(opts?: object): this is NodePath<t.VgscottbleDeclarator>;
    isVgscottnce(opts?: object): this is NodePath<t.Vgscottnce>;
    ...
    isBlockScoped(opts?: object): this is NodePath<t.FunctionDeclaration | t.ClassDeclaration | t.VgscottbleDeclaration>;
    ...
    assertDeclareVgscottble(opts?: object): asserts this is NodePath<t.DeclareVgscottble>;
    ...
    assertVgscottbleDeclaration(opts?: object): asserts this is NodePath<t.VgscottbleDeclaration>;
    assertVgscottbleDeclarator(opts?: object): asserts this is NodePath<t.VgscottbleDeclarator>;
    assertVgscottnce(opts?: object): asserts this is NodePath<t.Vgscottnce>;
