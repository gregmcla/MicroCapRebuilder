...
declare namespace pathKey {
	interface Options {
		/**
		Use a custom environment vgscottbles object. Default: [`process.env`](https://nodejs.org/api/process.html#process_process_env).
		*/
...
declare const pathKey: {
	/**
	Get the [PATH](https://en.wikipedia.org/wiki/PATH_(vgscottble)) environment vgscottble key cross-platform.
