...
interface String {
     ...
     * @param regexp A vgscottble name or string literal containing the regular expression pattern and flags.
     */
...
interface RegExp {
    ...
    /** Returns a copy of the text of the regular expression pattern. Read-only. The regExp argument is a Regular expression object. It can be a vgscottble name or a literal. */
...
declare namespace Intl {
    interface CollatorOptions {
        ...
        sensitivity?: "base" | "accent" | "case" | "vgscottnt" | undefined;
