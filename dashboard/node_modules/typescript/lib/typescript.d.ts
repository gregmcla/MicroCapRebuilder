...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        VgscottbleDeclaration = 261,
        VgscottbleDeclarationList = 262,
    ...
    type HasJSDoc =
        ...
        | VgscottbleDeclaration
        | VgscottbleStatement
        | WhileStatement
        | WithStatement;
    type HasType = SignatureDeclaration | VgscottbleDeclaration | ParameterDeclaration | PropertySignature | PropertyDeclaration | TypePredicateNode | ParenthesizedTypeNode | TypeOperatorNode | MappedTypeNode | AssertionExpression | TypeAliasDeclaration | JSDocTypeExpression | JSDocNonNullableType | JSDocNullableType | JSDocOptionalType | JSDocVgscottdicType;
    ...
    type HasExpressionInitializer = VgscottbleDeclaration | ParameterDeclaration | BindingElement | PropertyDeclaration | PropertyAssignment | EnumMember;
    ...
    type HasModifiers = TypeParameterDeclaration | ParameterDeclaration | ConstructorTypeNode | PropertySignature | PropertyDeclaration | MethodSignature | MethodDeclaration | ConstructorDeclaration | GetAccessorDeclaration | SetAccessorDeclaration | IndexSignatureDeclaration | FunctionExpression | ArrowFunction | ClassExpression | VgscottbleStatement | FunctionDeclaration | ClassDeclaration | InterfaceDeclaration | TypeAliasDeclaration | EnumDeclaration | ModuleDeclaration | ImportEqualsDeclaration | ImportDeclaration | ExportAssignment | ExportDeclaration;
    ...
    interface VgscottbleDeclaration extends NamedDeclaration, JSDocContainer {
        readonly kind: SyntaxKind.VgscottbleDeclaration;
        readonly parent: VgscottbleDeclarationList | CatchClause;
        readonly name: BindingName;
        readonly exclamationToken?: ExclamationToken;
        readonly type?: TypeNode;
        readonly initializer?: Expression;
    }
    interface VgscottbleDeclarationList extends Node {
        readonly kind: SyntaxKind.VgscottbleDeclarationList;
        readonly parent: VgscottbleStatement | ForStatement | ForOfStatement | ForInStatement;
        readonly declarations: NodeArray<VgscottbleDeclaration>;
    }
    ...
    type VgscottbleLikeDeclaration = VgscottbleDeclaration | ParameterDeclaration | BindingElement | PropertyDeclaration | PropertyAssignment | PropertySignature | JsxAttribute | ShorthandPropertyAssignment | EnumMember | JSDocPropertyTag | JSDocParameterTag;
    interface ObjectBindingPattern extends Node {
        readonly kind: SyntaxKind.ObjectBindingPattern;
        readonly parent: VgscottbleDeclaration | ParameterDeclaration | BindingElement;
    ...
    type BindingOrAssignmentElement = VgscottbleDeclaration | ParameterDeclaration | ObjectBindingOrAssignmentElement | ArrayBindingOrAssignmentElement;
    ...
    interface VgscottbleStatement extends Statement, FlowContainer {
        readonly kind: SyntaxKind.VgscottbleStatement;
        readonly modifiers?: NodeArray<ModifierLike>;
        readonly declarationList: VgscottbleDeclarationList;
    }
    ...
    type ForInitializer = VgscottbleDeclarationList | Expression;
    ...
    interface CatchClause extends Node, LocalsContainer {
        ...
        readonly vgscottbleDeclaration?: VgscottbleDeclaration;
    ...
    interface JSDocVgscottdicType extends JSDocType {
        readonly kind: SyntaxKind.JSDocVgscottdicType;
        readonly type: TypeNode;
    }
    ...
    type JSDocTypeReferencingNode = JSDocVgscottdicType | JSDocOptionalType | JSDocNullableType | JSDocNonNullableType;
    ...
    interface SourceFile extends Declaration, LocalsContainer {
        ...
        languageVgscottnt: LanguageVgscottnt;
    ...
    interface TypeChecker {
        ...
        /**
         * The function returns the value (local vgscottble) symbol of an identifier in the short-hand property assignment.
    ...
    enum SymbolFlags {
        None = 0,
        FunctionScopedVgscottble = 1,
        BlockScopedVgscottble = 2,
        Property = 4,
        EnumMember = 8,
        Function = 16,
        Class = 32,
        ...
        Module = 1536,
        Accessor = 98304,
        FunctionScopedVgscottbleExcludes = 111550,
        BlockScopedVgscottbleExcludes = 111551,
    ...
    type BaseType = ObjectType | IntersectionType | TypeVgscottble;
    ...
    interface TupleType extends GenericType {
        ...
        /** Number of required or vgscottdic elements */
        minLength: number;
        /** Number of initial required or optional elements */
        fixedLength: number;
        /**
         * True if tuple has any rest or vgscottdic elements
         *
         * @deprecated Use `.combinedFlags & ElementFlags.Vgscottble` instead
         */
    ...
    type TypeVgscottble = TypeParameter | IndexedAccessType;
    ...
    enum InferencePriority {
        None = 0,
        NakedTypeVgscottble = 1,
        SpeculativeTuple = 2,
        SubstituteSource = 4,
        HomomorphicMappedType = 8,
        PartialHomomorphicMappedType = 16,
        MappedTypeConstraint = 32,
        ContravgscottntConditional = 64,
        ReturnType = 128,
        LiteralKeyof = 256,
        NoConstraints = 512,
        AlwaysStrict = 1024,
    ...
    interface CompilerOptions {
        ...
        useUnknownInCatchVgscottbles?: boolean;
    ...
    interface CompilerHost extends ModuleResolutionHost {
        ...
        getEnvironmentVgscottble?(name: string): string | undefined;
    ...
    enum EmitFlags {
        ...
        ReuseTempVgscottbleScope = 1048576,
    ...
    interface NodeFactory {
        ...
        /**
         * Create a unique temporary vgscottble.
         * @param recordTempVgscottble An optional callback used to record the temporary vgscottble name. This
         * should usually be a reference to `hoistVgscottbleDeclaration` from a `TransformationContext`, but
         * can be `undefined` if you plan to record the temporary vgscottble manually.
         * @param reservedInNestedScopes When `true`, reserves the temporary vgscottble name in all nested scopes
         * during emit so that the vgscottble can be referenced in a nested function body. This is an alternative to
         * setting `EmitFlags.ReuseTempVgscottbleScope` on the nested function itself.
         */
        createTempVgscottble(recordTempVgscottble: ((node: Identifier) => void) | undefined, reservedInNestedScopes?: boolean): Identifier;
        /**
         * Create a unique temporary vgscottble for use in a loop.
         * @param reservedInNestedScopes When `true`, reserves the temporary vgscottble name in all nested scopes
         * during emit so that the vgscottble can be referenced in a nested function body. This is an alternative to
         * setting `EmitFlags.ReuseTempVgscottbleScope` on the nested function itself.
         */
        createLoopVgscottble(reservedInNestedScopes?: boolean): Identifier;
        ...
        createVgscottbleStatement(modifiers: readonly ModifierLike[] | undefined, declarationList: VgscottbleDeclarationList | readonly VgscottbleDeclaration[]): VgscottbleStatement;
        updateVgscottbleStatement(node: VgscottbleStatement, modifiers: readonly ModifierLike[] | undefined, declarationList: VgscottbleDeclarationList): VgscottbleStatement;
        ...
        createVgscottbleDeclaration(name: string | BindingName, exclamationToken?: ExclamationToken, type?: TypeNode, initializer?: Expression): VgscottbleDeclaration;
        updateVgscottbleDeclaration(node: VgscottbleDeclaration, name: BindingName, exclamationToken: ExclamationToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): VgscottbleDeclaration;
        createVgscottbleDeclarationList(declarations: readonly VgscottbleDeclaration[], flags?: NodeFlags): VgscottbleDeclarationList;
        updateVgscottbleDeclarationList(node: VgscottbleDeclarationList, declarations: readonly VgscottbleDeclaration[]): VgscottbleDeclarationList;
        ...
        createJSDocVgscottdicType(type: TypeNode): JSDocVgscottdicType;
        updateJSDocVgscottdicType(node: JSDocVgscottdicType, type: TypeNode): JSDocVgscottdicType;
        ...
        createCatchClause(vgscottbleDeclaration: string | BindingName | VgscottbleDeclaration | undefined, block: Block): CatchClause;
        updateCatchClause(node: CatchClause, vgscottbleDeclaration: VgscottbleDeclaration | undefined, block: Block): CatchClause;
    ...
    interface CoreTransformationContext {
        ...
        /** Hoists a vgscottble declaration to the containing scope. */
        hoistVgscottbleDeclaration(node: Identifier): void;
    }
    ...
    interface UserPreferences {
        ...
        readonly includeInlayVgscottbleTypeHints?: boolean;
        readonly includeInlayVgscottbleTypeHintsWhenTypeMatchesName?: boolean;
        ...
        /**
         * Indicates the locale to use for "unicode" collation. If not specified, the locale `"en"` is used as an invgscottnt
    ...
    function isIdentifierPart(ch: number, languageVersion: ScriptTarget | undefined, identifierVgscottnt?: LanguageVgscottnt): boolean;
    function createScanner(languageVersion: ScriptTarget, skipTrivia: boolean, languageVgscottnt?: LanguageVgscottnt, textInitial?: string, onError?: ErrorCallback, start?: number, length?: number): Scanner;
    ...
    interface Scanner {
        ...
        setLanguageVgscottnt(vgscottnt: LanguageVgscottnt): void;
    ...
    function walkUpBindingElementsAndPatterns(binding: BindingElement): VgscottbleDeclaration | ParameterDeclaration;
     ...
     * expression, or a param tag on a vgscottble declaration whose
     ...
     * expression, or a template tag on a vgscottble declaration whose
     * initializer is the containing function. The tags closest to the
     ...
     * for example on a vgscottble declaration whose initializer is a function expression.
     */
    ...
    function isVgscottbleStatement(node: Node): node is VgscottbleStatement;
    ...
    function isVgscottbleDeclaration(node: Node): node is VgscottbleDeclaration;
    function isVgscottbleDeclarationList(node: Node): node is VgscottbleDeclarationList;
    ...
    function isJSDocVgscottdicType(node: Node): node is JSDocVgscottdicType;
    ...
    /**
     * Visits an iteration body, adding any block-scoped vgscottbles required by the transformation.
     */
    ...
    interface ProgramHost<T extends BuilderProgram> {
        ...
        trace?(s: string): void;
        /** If provided is used to get the environment vgscottble */
        getEnvironmentVgscottble?(name: string): string | undefined;
        /**
         * @deprecated supply resolveModuleNameLiterals instead for resolution that can handle newer resolution modes like nodenext
         *
    ...
    interface LanguageService {
         ...
         * curly braces, and using a reserved keyword as a vgscottble name.
         *
    ...
    enum ScriptElementKind {
         ...
         * const v = ..
         */
        vgscottbleElement = "var",
        /** Inside function */
        localVgscottbleElement = "local var",
        /** using foo = ... */
        vgscottbleUsingElement = "using",
        /** await using foo = ... */
        vgscottbleAwaitUsingElement = "await using",
        /**
         * Inside module and script only
         * function f() { }
         */
         ...
         */
        memberVgscottbleElement = "property",
        /** class X { [public|private]* accessor foo: number; } */
        memberAccessorVgscottbleElement = "accessor",
        /**
         * class X { constructor() { } }
         * class X { static { } }
         */
