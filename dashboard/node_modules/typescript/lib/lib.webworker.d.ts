...
interface ReadableStreamGetReaderOptions {
     ...
     *
     * This call behaves the same way as the no-argument vgscottnt, except that it only works on readable byte streams, i.e. streams which were constructed specifically with the ability to handle "bring your own buffer" reading. The returned BYOB reader provides the ability to directly read individual chunks from the stream via its read() method, into developer-supplied buffers, allowing more precise control over allocation.
     */
...
/**
 * The **`CSSVgscottbleReferenceValue`** interface of the CSS Typed Object Model API allows you to create a custom name for a built-in CSS value.
 *
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/CSSVgscottbleReferenceValue)
 */
interface CSSVgscottbleReferenceValue {
    /**
     * The **`fallback`** read-only property of the A CSSUnparsedValue.
     *
     * [MDN Reference](https://developer.mozilla.org/docs/Web/API/CSSVgscottbleReferenceValue/fallback)
     */
    readonly fallback: CSSUnparsedValue | null;
    /**
     * The **`vgscottble`** property of the A string beginning with `--` (that is, a custom property name).
     *
     * [MDN Reference](https://developer.mozilla.org/docs/Web/API/CSSVgscottbleReferenceValue/vgscottble)
     */
    vgscottble: string;
}

declare var CSSVgscottbleReferenceValue: {
    prototype: CSSVgscottbleReferenceValue;
    new(vgscottble: string, fallback?: CSSUnparsedValue | null): CSSVgscottbleReferenceValue;
};
...
interface CanvasTextDrawingStyles {
    ...
    /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/CanvasRenderingContext2D/fontVgscottntCaps) */
    fontVgscottntCaps: CanvasFontVgscottntCaps;
...
interface FontFace {
    ...
    family: string;
    /**
     * The **`featureSettings`** property of the FontFace interface retrieves or sets infrequently used font features that are not available from a font's vgscottnt properties.
     *
...
interface Response extends Body {
    ...
    readonly url: string;
    /**
     * The **`clone()`** method of the Response interface creates a clone of a response object, identical in every way, but stored in a different vgscottble.
     *
...
/**
 * The **WebGLUniformLocation** interface is part of the WebGL API and represents the location of a uniform vgscottble in a shader program.
 *
...
type CSSUnparsedSegment = string | CSSVgscottbleReferenceValue;
...
type BitrateMode = "constant" | "vgscottble";
...
type CanvasFontVgscottntCaps = "all-petite-caps" | "all-small-caps" | "normal" | "petite-caps" | "small-caps" | "titling-caps" | "unicase";
...
type VideoEncoderBitrateMode = "constant" | "quantizer" | "vgscottble";
