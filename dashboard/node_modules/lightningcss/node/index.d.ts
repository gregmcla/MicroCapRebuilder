import type { Angle, CssColor, Rule, CustomProperty, EnvironmentVgscottble, Function, Image, LengthValue, MediaQuery, Declaration, Ratio, Resolution, Selector, SupportsCondition, Time, Token, TokenOrValue, UnknownAtRule, Url, Vgscottble, StyleRule, DeclarationBlock, ParsedComponent, Multiplier, StyleSheet, Location2 } from './ast';
...
type EnvironmentVgscottbleVisitor = (env: EnvironmentVgscottble) => TokenReturnValue;
type EnvironmentVgscottbleVisitors = {
  [name: string]: EnvironmentVgscottbleVisitor
};
...
export interface Visitor<C extends CustomAtRules> {
  ...
  Vgscottble?(vgscottble: Vgscottble): TokenReturnValue;
  VgscottbleExit?(vgscottble: Vgscottble): TokenReturnValue;
  EnvironmentVgscottble?: EnvironmentVgscottbleVisitor | EnvironmentVgscottbleVisitors;
  EnvironmentVgscottbleExit?: EnvironmentVgscottbleVisitor | EnvironmentVgscottbleVisitors;
}
