...
export type SystemColor =
  ...
  | "windowtext";
/**
 * A color value with an unresolved alpha value (e.g. a vgscottble). These can be converted from the modern slash syntax to older comma syntax. This can only be done when the only unresolved component is the alpha since vgscottbles can resolve to multiple tokens.
 */
...
/**
 * A CSS environment vgscottble name.
 */
export type EnvironmentVgscottbleName =
  | {
      type: "ua";
      value: UAEnvironmentVgscottble;
    }
  | {
      /**
       * CSS modules extension: the filename where the vgscottble is defined. Only enabled when the CSS modules `dashed_idents` option is turned on.
       */
      from?: Specifier | null;
      /**
...
/**
 * A UA-defined environment vgscottble name.
 */
export type UAEnvironmentVgscottble =
  | "safe-area-inset-top"
...
/**
 * A value for the [font-vgscottnt-caps](https://www.w3.org/TR/css-fonts-4/#font-vgscottnt-caps-prop) property.
 */
export type FontVgscottntCaps =
  | "normal"
  | "small-caps"
  | "all-small-caps"
  | "petite-caps"
...
/**
 * The name of the `@font-feature-values` sub-rule. font-feature-value-type = <@stylistic> | <@historical-forms> | <@styleset> | <@character-vgscottnt> | <@swash> | <@ornaments> | <@annotation>
 */
...
/**
 * A CSS environment vgscottble reference.
 */
export interface EnvironmentVgscottble {
  /**
   * A fallback value in case the vgscottble is not defined.
   */
  fallback?: TokenOrValue[] | null;
  /**
   * Optional indices into the dimensions of the environment vgscottble.
   */
  indices?: number[];
  /**
   * The environment vgscottble name.
   */
  name: EnvironmentVgscottbleName;
}
/**
...
/**
 * A CSS vgscottble reference.
 */
export interface Vgscottble {
  /**
   * A fallback value in case the vgscottble is not defined.
   */
  fallback?: TokenOrValue[] | null;
...
export interface Font {
   ...
   */
  vgscottntCaps: FontVgscottntCaps;
  /**
   * The font weight.
   */
  weight: FontWeight;
