...
declare class ReferenceTracker {
    ...
    private _iterateVgscottbleReferences;
...
declare function findVgscottble(initialScope: Scope$1, nameOrNode: string | Identifier): Vgscottble | null;
type Scope$1 = eslint.Scope.Scope;
type Vgscottble = eslint.Scope.Vgscottble;
