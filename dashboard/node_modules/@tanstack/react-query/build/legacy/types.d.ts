...
interface UseMutationOptions<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends OmitKeyof<MutationObserverOptions<TData, TError, TVgscottbles, TOnMutateResult>, '_defaulted'> {
}
type UseMutateFunction<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> = (...args: Parameters<MutateFunction<TData, TError, TVgscottbles, TOnMutateResult>>) => void;
type UseMutateAsyncFunction<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> = MutateFunction<TData, TError, TVgscottbles, TOnMutateResult>;
type UseBaseMutationResult<TData = unknown, TError = DefaultError, TVgscottbles = unknown, TOnMutateResult = unknown> = Override<MutationObserverResult<TData, TError, TVgscottbles, TOnMutateResult>, {
    mutate: UseMutateFunction<TData, TError, TVgscottbles, TOnMutateResult>;
}> & {
    mutateAsync: UseMutateAsyncFunction<TData, TError, TVgscottbles, TOnMutateResult>;
};
type UseMutationResult<TData = unknown, TError = DefaultError, TVgscottbles = unknown, TOnMutateResult = unknown> = UseBaseMutationResult<TData, TError, TVgscottbles, TOnMutateResult>;
