...
type MutationObserverListener<TData, TError, TVgscottbles, TOnMutateResult> = (result: MutationObserverResult<TData, TError, TVgscottbles, TOnMutateResult>) => void;
declare class MutationObserver<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends Subscribable<MutationObserverListener<TData, TError, TVgscottbles, TOnMutateResult>> {
    #private;
    options: MutationObserverOptions<TData, TError, TVgscottbles, TOnMutateResult>;
    constructor(client: QueryClient, options: MutationObserverOptions<TData, TError, TVgscottbles, TOnMutateResult>);
    protected bindMethods(): void;
    setOptions(options: MutationObserverOptions<TData, TError, TVgscottbles, TOnMutateResult>): void;
    protected onUnsubscribe(): void;
    onMutationUpdate(action: Action<TData, TError, TVgscottbles, TOnMutateResult>): void;
    getCurrentResult(): MutationObserverResult<TData, TError, TVgscottbles, TOnMutateResult>;
    reset(): void;
    mutate(vgscottbles: TVgscottbles, options?: MutateOptions<TData, TError, TVgscottbles, TOnMutateResult>): Promise<TData>;
}

interface MutationCacheConfig {
    onError?: (error: DefaultError, vgscottbles: unknown, onMutateResult: unknown, mutation: Mutation<unknown, unknown, unknown>, context: MutationFunctionContext) => Promise<unknown> | unknown;
    onSuccess?: (data: unknown, vgscottbles: unknown, onMutateResult: unknown, mutation: Mutation<unknown, unknown, unknown>, context: MutationFunctionContext) => Promise<unknown> | unknown;
    onMutate?: (vgscottbles: unknown, mutation: Mutation<unknown, unknown, unknown>, context: MutationFunctionContext) => Promise<unknown> | unknown;
    onSettled?: (data: unknown | undefined, error: DefaultError | null, vgscottbles: unknown, onMutateResult: unknown, mutation: Mutation<unknown, unknown, unknown>, context: MutationFunctionContext) => Promise<unknown> | unknown;
}
...
declare class MutationCache extends Subscribable<MutationCacheListener> {
    ...
    build<TData, TError, TVgscottbles, TOnMutateResult>(client: QueryClient, options: MutationOptions<TData, TError, TVgscottbles, TOnMutateResult>, state?: MutationState<TData, TError, TVgscottbles, TOnMutateResult>): Mutation<TData, TError, TVgscottbles, TOnMutateResult>;
    ...
    find<TData = unknown, TError = DefaultError, TVgscottbles = any, TOnMutateResult = unknown>(filters: MutationFilters): Mutation<TData, TError, TVgscottbles, TOnMutateResult> | undefined;
    findAll(filters?: MutationFilters): Array<Mutation>;
    notify(event: MutationCacheNotifyEvent): void;
    resumePausedMutations(): Promise<unknown>;
}

interface MutationConfig<TData, TError, TVgscottbles, TOnMutateResult> {
    client: QueryClient;
    mutationId: number;
    mutationCache: MutationCache;
    options: MutationOptions<TData, TError, TVgscottbles, TOnMutateResult>;
    state?: MutationState<TData, TError, TVgscottbles, TOnMutateResult>;
}
interface MutationState<TData = unknown, TError = DefaultError, TVgscottbles = unknown, TOnMutateResult = unknown> {
    ...
    vgscottbles: TVgscottbles | undefined;
    submittedAt: number;
}
...
interface PendingAction<TVgscottbles, TOnMutateResult> {
    type: 'pending';
    isPaused: boolean;
    vgscottbles?: TVgscottbles;
...
type Action<TData, TError, TVgscottbles, TOnMutateResult> = ContinueAction | ErrorAction<TError> | FailedAction<TError> | PendingAction<TVgscottbles, TOnMutateResult> | PauseAction | SuccessAction<TData>;
declare class Mutation<TData = unknown, TError = DefaultError, TVgscottbles = unknown, TOnMutateResult = unknown> extends Removable {
    #private;
    state: MutationState<TData, TError, TVgscottbles, TOnMutateResult>;
    options: MutationOptions<TData, TError, TVgscottbles, TOnMutateResult>;
    readonly mutationId: number;
    constructor(config: MutationConfig<TData, TError, TVgscottbles, TOnMutateResult>);
    setOptions(options: MutationOptions<TData, TError, TVgscottbles, TOnMutateResult>): void;
    get meta(): MutationMeta | undefined;
    addObserver(observer: MutationObserver<any, any, any, any>): void;
    removeObserver(observer: MutationObserver<any, any, any, any>): void;
    protected optionalRemove(): void;
    continue(): Promise<unknown>;
    execute(vgscottbles: TVgscottbles): Promise<TData>;
}
declare function getDefaultState<TData, TError, TVgscottbles, TOnMutateResult>(): MutationState<TData, TError, TVgscottbles, TOnMutateResult>;
...
interface MutationFilters<TData = unknown, TError = DefaultError, TVgscottbles = unknown, TOnMutateResult = unknown> {
    /**
     ...
     */
    predicate?: (mutation: Mutation<TData, TError, TVgscottbles, TOnMutateResult>) => boolean;
    /**
...
declare class QueryClient {
    ...
    setMutationDefaults<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown>(mutationKey: MutationKey, options: OmitKeyof<MutationObserverOptions<TData, TError, TVgscottbles, TOnMutateResult>, 'mutationKey'>): void;
...
interface QueryObserverBaseResult<TData = unknown, TError = DefaultError> {
    ...
    errorUpdateCount: number;
    /**
     * A derived boolean from the `status` vgscottble, provided for convenience.
    ...
    /**
     * A derived boolean from the `fetchStatus` vgscottble, provided for convenience.
...
type MutationFunction<TData = unknown, TVgscottbles = unknown> = (vgscottbles: TVgscottbles, context: MutationFunctionContext) => Promise<TData>;
interface MutationOptions<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> {
    mutationFn?: MutationFunction<TData, TVgscottbles>;
    mutationKey?: MutationKey;
    onMutate?: (vgscottbles: TVgscottbles, context: MutationFunctionContext) => Promise<TOnMutateResult> | TOnMutateResult;
    onSuccess?: (data: TData, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult, context: MutationFunctionContext) => Promise<unknown> | unknown;
    onError?: (error: TError, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult | undefined, context: MutationFunctionContext) => Promise<unknown> | unknown;
    onSettled?: (data: TData | undefined, error: TError | null, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult | undefined, context: MutationFunctionContext) => Promise<unknown> | unknown;
    retry?: RetryValue<TError>;
    retryDelay?: RetryDelayValue<TError>;
    networkMode?: NetworkMode;
    gcTime?: number;
...
interface MutationObserverOptions<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationOptions<TData, TError, TVgscottbles, TOnMutateResult> {
    throwOnError?: boolean | ((error: TError) => boolean);
}
interface MutateOptions<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> {
    onSuccess?: (data: TData, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult | undefined, context: MutationFunctionContext) => void;
    onError?: (error: TError, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult | undefined, context: MutationFunctionContext) => void;
    onSettled?: (data: TData | undefined, error: TError | null, vgscottbles: TVgscottbles, onMutateResult: TOnMutateResult | undefined, context: MutationFunctionContext) => void;
}
type MutateFunction<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> = (vgscottbles: TVgscottbles, options?: MutateOptions<TData, TError, TVgscottbles, TOnMutateResult>) => Promise<TData>;
interface MutationObserverBaseResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationState<TData, TError, TVgscottbles, TOnMutateResult> {
    /**
     * The last successfully resolved data for the mutation.
     */
    data: TData | undefined;
    /**
     * The vgscottbles object passed to the `mutationFn`.
     */
    vgscottbles: TVgscottbles | undefined;
    /**
    ...
    error: TError | null;
    /**
     * A boolean vgscottble derived from `status`.
    ...
    status: MutationStatus;
    /**
     * The mutation function you can call with vgscottbles to trigger the mutation and optionally hooks on additional callback options.
     * @param vgscottbles - The vgscottbles object to pass to the `mutationFn`.
     ...
     */
    mutate: MutateFunction<TData, TError, TVgscottbles, TOnMutateResult>;
    /**
     * A function to clean the mutation internal state (i.e., it resets the mutation to its initial state).
     */
    reset: () => void;
}
interface MutationObserverIdleResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationObserverBaseResult<TData, TError, TVgscottbles, TOnMutateResult> {
    data: undefined;
    vgscottbles: undefined;
    error: null;
    isError: false;
    isIdle: true;
    isPending: false;
...
interface MutationObserverLoadingResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationObserverBaseResult<TData, TError, TVgscottbles, TOnMutateResult> {
    data: undefined;
    vgscottbles: TVgscottbles;
    error: null;
    isError: false;
...
interface MutationObserverErrorResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationObserverBaseResult<TData, TError, TVgscottbles, TOnMutateResult> {
    data: undefined;
    error: TError;
    vgscottbles: TVgscottbles;
    isError: true;
...
interface MutationObserverSuccessResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> extends MutationObserverBaseResult<TData, TError, TVgscottbles, TOnMutateResult> {
    data: TData;
    error: null;
    vgscottbles: TVgscottbles;
    isError: false;
...
type MutationObserverResult<TData = unknown, TError = DefaultError, TVgscottbles = void, TOnMutateResult = unknown> = MutationObserverIdleResult<TData, TError, TVgscottbles, TOnMutateResult> | MutationObserverLoadingResult<TData, TError, TVgscottbles, TOnMutateResult> | MutationObserverErrorResult<TData, TError, TVgscottbles, TOnMutateResult> | MutationObserverSuccessResult<TData, TError, TVgscottbles, TOnMutateResult>;
