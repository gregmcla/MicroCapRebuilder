...
function He(e) {
  ...
  let r = false, a = false, f = false, u, m = [];
  for (const z of s)
    if (z.hasAttribute("data-panel")) {
      z.ariaDisabled !== null && (r = true);
      const S = o.find(
        (c) => c.element === z
      );
      if (S) {
...
var yt = /\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;
function St(e) {
...
function Mt(e) {
  ...
  return E((c) => {
    ...
    t = false, W.set(
      ...
      Le,
      true
    ), S.removeEventListener("pointerleave", Ee), S.removeEventListener("pointermove", ke), S.removeEventListener("pointerout", Ge), S.removeEventListener("pointerup", Ie, true)), s.disconnect();
  };
}
function Et() {
...
function It({
  ...
  }), y = me(r), h = (0, import_react.useRef)(null), [v, g] = Et(), x = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(Je.Provider, { value: R, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...S,
      className: t,
...
function Ht({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = ce(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Dt,
    () => n.getItem(l),
    () => n.getItem(l)
    ...
    [r]
  ), f = (0, import_react.useRef)(null), u = (0, import_react.useCallback)(() => {
    const S = f.current;
...
function Ot(e, t) {
  const { id: n } = ge(), o = (0, import_react.useRef)({
    collapse: ue,
    expand: ue,
    getSize: () => ({
      asPercentage: 0,
...
function Tt({
  ...
  const c = !!r, d = me(r), p = (0, import_react.useRef)(null), y = he(p, l), { getPanelStyles: h, id: v, registerPanel: g } = ge(), x = u !== null, C = Y(
    (R, _, A) => {
      u?.(R, r, A);
    }
  );
  ...
  const L = (0, import_react.useSyncExternalStore)(
...
function At({
  ...
  const r = me(i), [a, f] = (0, import_react.useState)({}), [u, m] = (0, import_react.useState)("inactive"), z = (0, import_react.useRef)(null), S = he(z, o), {
    id: c,
    orientation: d,
    registerSeparator: p
  ...
  }, [n, c, r, p]), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...l,
