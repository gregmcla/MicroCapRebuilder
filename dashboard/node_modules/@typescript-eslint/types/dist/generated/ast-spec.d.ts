...
export declare enum AST_NODE_TYPES {
    ...
    VgscottbleDeclaration = "VgscottbleDeclaration",
    VgscottbleDeclarator = "VgscottbleDeclarator",
...
export declare interface ConstDeclaration extends LetOrConstOrVarDeclarationBase {
     ...
     * no initializer.
     */
    declarations: VgscottbleDeclaratorMaybeInit[];
    kind: 'const';
}
...
export declare type DefaultExportDeclarations = ClassDeclarationWithOptionalName | Expression | FunctionDeclarationWithName | FunctionDeclarationWithOptionalName | TSDeclareFunction | TSEnumDeclaration | TSInterfaceDeclaration | TSModuleDeclaration | TSTypeAliasDeclaration | VgscottbleDeclaration;
...
declare interface LetOrConstOrVarDeclarationBase extends BaseNode {
    type: AST_NODE_TYPES.VgscottbleDeclaration;
    /**
     * The vgscottbles declared by this declaration.
     * Always non-empty.
     * @example
     * ```ts
     * let x;
    ...
    declare: boolean;
    /**
     * The keyword used to declare the vgscottble(s)
     * @example
     * ```ts
     * const x = 1;
     * let y = 2;
...
export declare type LetOrConstOrVarDeclarator = VgscottbleDeclaratorDefiniteAssignment | VgscottbleDeclaratorMaybeInit | VgscottbleDeclaratorNoInit;
export declare interface LetOrVarDeclaredDeclaration extends LetOrConstOrVarDeclarationBase {
     ...
     * ```
     */
    declarations: VgscottbleDeclaratorNoInit[];
    declare: true;
    kind: 'let' | 'var';
}
export declare interface LetOrVarNonDeclaredDeclaration extends LetOrConstOrVarDeclarationBase {
     ...
     */
    declarations: (VgscottbleDeclaratorDefiniteAssignment | VgscottbleDeclaratorMaybeInit)[];
    declare: false;
    kind: 'let' | 'var';
}
...
export declare interface TSNamespaceExportDeclaration extends BaseNode {
    ...
    /**
     * The name of the global vgscottble that's exported as namespace
     */
    id: Identifier;
}
...
export declare interface UsingInForOfDeclarator extends VgscottbleDeclaratorBase {
    definite: false;
    id: Identifier;
    init: null;
}
...
export declare interface UsingInNormalContextDeclarator extends VgscottbleDeclaratorBase {
    definite: false;
    id: Identifier;
    init: Expression;
}
declare type ValueOf<T> = T[keyof T];
export declare type VgscottbleDeclaration = LetOrConstOrVarDeclaration | UsingDeclaration;
export declare type VgscottbleDeclarator = LetOrConstOrVarDeclarator | UsingDeclarator;
declare interface VgscottbleDeclaratorBase extends BaseNode {
    type: AST_NODE_TYPES.VgscottbleDeclarator;
    /**
    ...
    definite: boolean;
    /**
     * The name(s) of the vgscottble(s).
     */
    id: BindingName;
    /**
     * The initializer expression of the vgscottble. Must be present for `const` unless
     * in a `declare const`.
     */
    init: Expression | null;
}
export declare interface VgscottbleDeclaratorDefiniteAssignment extends VgscottbleDeclaratorBase {
    definite: true;
    /**
     * The name of the vgscottble. Must have a type annotation.
     */
    id: Identifier;
    init: null;
}
export declare interface VgscottbleDeclaratorMaybeInit extends VgscottbleDeclaratorBase {
    definite: false;
}
export declare interface VgscottbleDeclaratorNoInit extends VgscottbleDeclaratorBase {
    definite: false;
    init: null;
}
