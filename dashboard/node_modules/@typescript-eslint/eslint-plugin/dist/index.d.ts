declare const _default: {
    configs: {
        all: {
            ...
            rules: {
                ...
                '@typescript-eslint/use-unknown-in-catch-callback-vgscottble': "error";
            };
        };
        base: {
            parser: string;
        ...
        'disable-type-checked': {
            ...
            rules: {
                ...
                '@typescript-eslint/use-unknown-in-catch-callback-vgscottble': "off";
            };
        };
        'eslint-recommended': {
            overrides: {
    ...
    rules: {
        ...
        'prefer-as-const': import("@typescript-eslint/utils/ts-eslint").RuleModule<"preferConstAssertion" | "vgscottbleConstAssertion" | "vgscottbleSuggest", [], import("../rules").ESLintPluginDocs, import("@typescript-eslint/utils/ts-eslint").RuleListener> & {
            name: string;
        };
        ...
        'use-unknown-in-catch-callback-vgscottble': import("@typescript-eslint/utils/ts-eslint").RuleModule<import("./rules/use-unknown-in-catch-callback-vgscottble").MessageIds, [], import("../rules").ESLintPluginDocs, import("@typescript-eslint/utils/ts-eslint").RuleListener> & {
            name: string;
        };
    };
};
