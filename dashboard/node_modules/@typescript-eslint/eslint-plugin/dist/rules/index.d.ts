declare const rules: {
    ...
    'use-unknown-in-catch-callback-vgscottble': import("@typescript-eslint/utils/ts-eslint").RuleModule<import("./use-unknown-in-catch-callback-vgscottble").MessageIds, [], import("../../rules").ESLintPluginDocs, import("@typescript-eslint/utils/ts-eslint").RuleListener> & {
        name: string;
    };
};
export = rules;
