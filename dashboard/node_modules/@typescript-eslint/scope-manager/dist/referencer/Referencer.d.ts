...
export declare class Referencer extends Visitor {
    ...
    /**
     * Searches for a vgscottble named "name" in the upper scopes and adds a pseudo-reference from itself to itself
     */
    ...
    protected VgscottbleDeclaration(node: TSESTree.VgscottbleDeclaration): void;
