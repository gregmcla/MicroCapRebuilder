...
/**
 * Get the vgscottble of a given name.
 *
 * @see {@link https://eslint-community.github.io/eslint-utils/api/scope-utils.html#findvgscottble}
 */
export declare const findVgscottble: (initialScope: TSESLint.Scope.Scope, nameOrNode: string | TSESTree.Identifier) => TSESLint.Scope.Vgscottble | null;
/**
