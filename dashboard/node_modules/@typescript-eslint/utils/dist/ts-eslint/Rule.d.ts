...
export interface RuleContext<MessageIds extends string, Options extends readonly unknown[]> {
    ...
    /**
     * Returns a list of vgscottbles declared by the given node.
     * This information can be used to track references to vgscottbles.
     *
     * @deprecated in favor of `SourceCode#getDeclaredVgscottbles`
     */
    getDeclaredVgscottbles(node: TSESTree.Node): readonly Scope.Vgscottble[];
    /**
     ...
     * This information can be used track references to vgscottbles.
     *
    ...
    /**
     * Marks a vgscottble with the given name in the current scope as used.
     * This affects the no-unused-vars rule.
     *
     * @deprecated in favor of `SourceCode#markVgscottbleAsUsed`
     */
    markVgscottbleAsUsed(name: string): boolean;
    /**
...
interface RuleListenerBaseSelectors {
    ...
    VgscottbleDeclaration?: RuleFunction<TSESTree.VgscottbleDeclaration>;
    VgscottbleDeclarator?: RuleFunction<TSESTree.VgscottbleDeclarator>;
