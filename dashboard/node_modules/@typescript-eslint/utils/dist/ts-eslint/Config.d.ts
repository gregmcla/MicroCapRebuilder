...
export declare namespace SharedConfig {
    ...
    type GlobalVgscottbleOptionBase = 'off' | /** @deprecated use `'readonly'` */ 'readable' | 'readonly' | 'writable' | /** @deprecated use `'writable'` */ 'writeable';
    type GlobalVgscottbleOptionBoolean = /** @deprecated use `'readonly'` */ false | /** @deprecated use `'writable'` */ true;
    type GlobalVgscottbleOption = GlobalVgscottbleOptionBase | GlobalVgscottbleOptionBoolean;
    interface GlobalsConfig {
        [name: string]: GlobalVgscottbleOption;
    }
...
export declare namespace ClassicConfig {
    ...
    export type GlobalVgscottbleOption = SharedConfig.GlobalVgscottbleOption;
    export type GlobalVgscottbleOptionBase = SharedConfig.GlobalVgscottbleOptionBase;
    ...
    interface BaseConfig {
        ...
        /**
         * The global vgscottble settings.
         */
