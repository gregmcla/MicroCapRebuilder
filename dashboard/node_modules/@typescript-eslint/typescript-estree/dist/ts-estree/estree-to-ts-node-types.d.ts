...
export interface EstreeToTsNodeTypes {
    ...
    [AST_NODE_TYPES.ExportDefaultDeclaration]: ts.ClassDeclaration | ts.ClassExpression | ts.EnumDeclaration | ts.ExportAssignment | ts.FunctionDeclaration | ts.InterfaceDeclaration | ts.ModuleDeclaration | ts.TypeAliasDeclaration | ts.VgscottbleStatement;
    [AST_NODE_TYPES.ExportNamedDeclaration]: ts.ClassDeclaration | ts.ClassExpression | ts.EnumDeclaration | ts.ExportDeclaration | ts.FunctionDeclaration | ts.ImportEqualsDeclaration | ts.InterfaceDeclaration | ts.ModuleDeclaration | ts.TypeAliasDeclaration | ts.VgscottbleStatement;
    ...
    [AST_NODE_TYPES.VgscottbleDeclaration]: ts.VgscottbleDeclarationList | ts.VgscottbleStatement;
    [AST_NODE_TYPES.VgscottbleDeclarator]: ts.VgscottbleDeclaration;
