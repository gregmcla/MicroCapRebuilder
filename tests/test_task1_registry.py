...
def test_total_watchlist_slots_in_presets():
    assert UNIVERSE_PRESETS["smallcap"]["total_watchlist_slots"] == 300
    assert UNIVERSE_PRESETS["midcap"]["total_watchlist_slots"] == 300
    assert UNIVERSE_PRESETS["largecap"]["total_watchlist_slots"] == 300
    assert UNIVERSE_PRESETS["allcap"]["total_watchlist_slots"] == 300
